...
//  golf2u
//
//  Created by 이원영 on 2020/12/21.
//  Copyright © 2020 이원영. All rights reserved.
//

import UIKit
import WebKit
class TutoialWeb:  VariousViewController, WKUIDelegate, WKNavigationDelegate {

    private var webview: WKWebView!
    private let m_sUserAgent : String = "Version/8.0.2 Safari/600.2.5"
    private var m_sUrl = "\(Single.DE_WEBAPIPROTOCOL)://\(Single.DE_URLSERVER)/api/Tutorial/detail";
    private var m_sTitle : String = "튜토리얼".localized;
    ...
    func setUrl(url : String, f_sTitle : String){
        m_sUrl = url
        m_sTitle = f_sTitle
    }
    //alert 처리
...
extension TutoialWeb: WKScriptMessageHandler {
