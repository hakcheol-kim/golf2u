...
class NoticeInfoDetail:  VariousViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    private var m_sNoticeSeq = "";
    
    override func viewDidLoad() {
        super.InitVC(type: Single.DE_INITNAVISUB, title: "공지사항 상세".localized)
        super.viewDidLoad()
        
        m_sUrl = "\(Single.DE_WEBAPIPROTOCOL)://\(Single.DE_URLSERVER)/api/Cs/webviewNotice/\(m_sNoticeSeq)";
...
extension NoticeInfoDetail: WKScriptMessageHandler {
